...
const Schedule = () => {
    return (
        <section className="elementor-section elementor-top-section elementor-element elementor-element-34b9fe05  elementor-section-content-middle elementor-section-stretched elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="34b9fe05" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classNameic&quot;,&quot;stretch_section&quot;:&quot;section-stretched&quot;}">
			...
			<p className="elementor-heading-title elementor-size-default">OUR PATIENTS LOVE US!</p>		</div>
				</div>
				...
				<div className="elementor-widget-container">
			<h1 className="elementor-heading-title elementor-size-default">PATIENT TESTIMONIALS</h1>		</div>
				</div>
				...
				<div className="elementor-widget-container">
					<div className="elementor-text-editor elementor-clearfix"><p>We know you want to see the reviews first! Browse the page below to see our reviews. Afterwards, It’s easy to schedule your appointment with us.&nbsp;</p><p>Just click “schedule now” as soon as you’re ready.</p></div>
				</div>
				</div>
